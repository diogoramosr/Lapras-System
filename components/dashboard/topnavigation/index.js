        ...
        <div className="flex items-center pl-1 relative w-full sm:ml-0 sm:pr-2 lg:max-w-68">
          <div className="flex group h-full items-center relative w-12">
            <button
              ...
              onClick={toggle}
              className="text-4xl text-black focus:outline-none mr-5"
            >
              &#8801;
            </button>
          </div>
          <div className="container flex left-0 relative w-3/4">
            <div className="group hidden items-center ml-8 relative w-full md:flex lg:w-72">
              ...
              <svg
                className="absolute fill-current h-4 hidden left-0 ml-4 pointer-events-none text-black w-4  sm:block"
              ...
              <input
                type="text"
                className="block leading-normal pl-10 py-1.5 pr-4 ring-opacity-90 rounded-2xl shadow-md text-black w-full focus:border-transparent focus:outline-none focus:ring-2 focus:ring-sky-700"
                placeholder="Search"
              />
            </div>
          </div>
          <div className="flex items-center justify-end ml-5 p-1 relative w-full sm:mr-0 sm:right-auto">
            <a href="#" className="block pr-5">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6 cursor-pointer hover:text-sky-700 duration-200"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
