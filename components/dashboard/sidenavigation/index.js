...
const style = {
  ...
  open: `absolute duration-500 ease-in transition-all w-8/12 z-40 sm:w-5/12 md:w-48`,
  default: `h-screen overflow-y-auto text-white top-0 lg:absolute bg-black lg:block lg:z-40`,
};
