  ...
  return (
    <>
      ...
      <div class="m-0 font-sans antialiased font-normal text-base leading-default bg-zinc-50 h-screen">
        <Sidebar />
        <div class="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%] bg-red-100">
          <NavbarDash title="Estatísticas Gerais" />
          <div class="pt-1 2xl:container h-full bg-green-300 fadeIn">
            <div class="pt-1 2xl:container h-full bg-green-300">
