...
export default function Admin() {
  ...
  return (
    <>
      <Head></Head>
      <div class="m-0 font-sans antialiased font-normal text-base leading-default dark:bg-[#121212] bg-zinc-50 h-screen">
        <Sidebar />
        <div class="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%] bg-zinc-50 dark:bg-[#121212]">
          <NavbarDash title="Estatísticas Gerais" />
          <div class="pt-1 2xl:container h-full bg-zinc-50 dark:bg-[#121212] fadeIn">
            <div class="pt-1 2xl:container h-full bg-zinc-50 dark:bg-[#121212]">
              <div class="flex justify-center items-center">
                <div class="w-full px-6 py-6 mx-auto">
                  <div class="flex flex-wrap mt-6 -mx-3">
                    <div class="w-full px-3 mb-6 lg:mb-0 lg:w-7/12 lg:flex-none">
                      <div class="relative flex flex-col min-w-0 break-words bg-white dark:bg-[#121212] shadow-md rounded-2xl bg-clip-border">
                    ...
                    <div class="w-full max-w-full px-3 lg:w-5/12 lg:flex-none relative">
                      <div class="border-black/12.5 shadow-md relative flex h-full min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white dark:bg-[#121212] bg-clip-border p-4">
                        <div class="relative h-full overflow-hidden bg-cover rounded-xl">
                          <span class="absolute top-0 left-0 w-full h-full  dark:bg-[#121212]"></span>
