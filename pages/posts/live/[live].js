          ...
          <div class="2xl:container h-full bg-zinc-50 dark:bg-gray-600 fadeIn">
            <div class="2xl:container h-full  dark:bg-gray-600">
              ...
              <div class="flex justify-center items-center">
                <div class="w-full px-6 py-6 mx-auto">
                  <div class="flex flex-wrap mt-3 items-start -mx-3 justify-between sm:h-full md:h-[30rem] lg:h-[30rem] p-2  ">
                    <div class="w-full h-full md:w-2/5 px-3 mb-6 md:mb-0 md:flex-none bg-red-100">
                      <div class="relative h-full flex flex-col min-w-0 break-words bg-white dark:bg-gray-500 shadow-md rounded-2xl bg-clip-border">
                        <div class="flex-auto p-4">
                          <div class="flex flex-wrap -mx-3 bg-slate-500 h-full">
                            <div class="h-full w-full px-3 lg:w-full lg:flex-none bg-green-700">
                              <div className="w-full h-full p-2 mx-auto rounded-lg dark:bg-gray-900 dark:text-gray-100 bg-yellow-200">
                                <div className="flex justify-between space-x-9 items-center bg-green-900">
                                ...
                                <div className="flex justify-between mt-8 space-x-4 dark:text-gray-400 bg-blue-50 ">
                    ...
                    <div class="flex gap-2 w-full h-full max-w-full px-3 md:w-[59.33%] p-2 bg-blue-300 lg:flex-none relative">
                      <div className="bg-red-900 w-full">
                        <div class="border-black/12.5 shadow-md relative md:w-2/5 flex min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white dark:bg-gray-500 bg-clip-border p-4 bg-red-100">
